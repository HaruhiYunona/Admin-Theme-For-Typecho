    ...
    <div class="typecho-login">
        ...
        <form action="<?php $options->registerAction(); ?>" method="post" name="register" role="form">
            ...
            <p>
                ...
                <input type="password" id="password" name="password" placeholder="<?php _e('密码,6-18位。'); ?>" value="" class="text-l w-100" />
            </p>
            <p>
                <label for="confirm" class="sr-only"><?php _e('再次输入密码'); ?></label>
                <input type="password" id="confirm" name="confirm" placeholder="<?php _e('再次输入密码。'); ?>" value="" class="text-l w-100" />
            </p>
            <p>
            ...
            <p class="submit">
                <button type="submit" class="btn btn-l w-100 primary"><?php _e('用户注册'); ?></button>
            </p>
        </form>
        ...
        <p class="more-link">
            ...
            &bull;
            <a href="<?php $options->adminUrl('login.php'); ?>"><?php _e('注册'); ?></a>
        </p>
    </div>
</div>
<?php 
